        ...
        <div className="flex items-center space-x-4">
          {!ready ? (
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {/* Dropdown Menu */}
              {showDropdown && (
                <div className="absolute right-0 mt-2 w-72 bg-white rounded-xl shadow-xl border border-gray-200 py-1 z-50">
                  {/* Connected Wallet Info */}
                  <div className="px-4 py-3 border-b border-gray-100">
                    <div className="flex items-center space-x-2 mb-2">
                      <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                      <div className="text-sm font-semibold text-gray-900">Connected Wallet</div>
                    </div>
                    <div className="text-xs text-gray-600 font-mono break-all mb-1">{address}</div>
                  ...
                  {/* Wallet Actions */}
                  <div className="py-1">
                    <button className="w-full text-left px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center space-x-3">
                    ...
                    <button
                      ...
                      className="w-full text-left px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center space-x-3"
                    >
                      <svg className="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="border-t border-gray-100">
                    <button
                      ...
                      className="w-full text-left px-4 py-2.5 text-sm text-red-600 hover:bg-red-50 transition-colors flex items-center space-x-3"
                    >
